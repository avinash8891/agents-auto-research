...
| 5 | Operationalize thesis contract | `ThesisContract` | compiler_operationalize | Needs detailed plan |
...
| 7 | trace_sdk engine | `TraceEngine` + exporter registry | trace_sdk | Needs detailed plan |
