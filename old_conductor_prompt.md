# Old Conductor Prompt (research_prompts.py @ main)

Source: `git show main:research_prompts.py` — 436 lines, captured before this branch split enforcement across prompt / doctrine / validator / harness gates.
