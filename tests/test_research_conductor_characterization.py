...
def test_conductor_reports_validation_failed_for_non_mechanism_json(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    _patch_conductor_runner(monkeypatch, {"suggested_theses": [], "should_stop": True})
    ...
    assert "story" in str(out.validation_reason)
