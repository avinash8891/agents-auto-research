...
def test_thesis_quality_section_rejects_repeated_thesis_id_with_prefixed_code() -> None:
    ...
    assert excinfo.value.rejection_code.startswith("thesis_quality_")
...
def test_config_validity_section_rejects_jaccard_overlap_with_prefixed_code() -> None:
    ...
    prior = [
        {
            "thesis_id": "prior_dup",
            "config_changes": {"entry_cutoff_time": "09:45", "rr_ratio": 3.0},
