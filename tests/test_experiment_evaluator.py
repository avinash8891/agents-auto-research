...
def test_not_worse_than_profit_factor_allows_small_declines_and_rejects_craters() -> None:
    ...
    assert evaluate_effect(effect, {"profit_factor": 2.0}, {"profit_factor": 1.9}) is True
    assert evaluate_effect(effect, {"profit_factor": 2.0}, {"profit_factor": 0.0}) is False
...
def test_not_worse_than_max_drawdown_keeps_lower_is_better_direction() -> None:
    ...
    assert evaluate_effect(effect, {"max_drawdown": 0.20}, {"max_drawdown": 0.21}) is True
    assert evaluate_effect(effect, {"max_drawdown": 0.20}, {"max_drawdown": 0.25}) is False
